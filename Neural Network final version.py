# -*- coding: utf-8 -*-
"""
Created on Fri Jun  9 02:40:57 2023
...
data = pd.read_csv("D:/TIPE23/train data/train.csv")
...
W1, b1, W2, b2, accuracy_history = gradient_descent(X_train, Y_train,0.1,1000)
...
dev_predictions = test_prediction(55, W1, b1, W2, b2)
